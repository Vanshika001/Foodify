<html>
<head>
    <title> Guest Signup | FOODIFY </title>
  </head>
...
<body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> FOODIFY </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container-fluid background" style="margin-top: 4%; margin-bottom: 2%;">
